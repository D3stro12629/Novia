<template>
  <div class="container">
    ...
    <div class="pcard mb-4">
      ...
      <div class="cover" :style="profile.cover
      ...
      <div class="pcard-body">
        <div class="hero-row">
          ...
          <div class="hero-info">
            ...
            <div class="meta-row">
              ...
              <a class="meta-pill meta-pill-link" v-if="profile.portfolio_link" :href="profile.portfolio_link"
                target="_blank">
        ...
        <!-- ── Tabs ── -->
        <nav class="tab-nav">
          <button v-for="tab in tabs" :key="tab.key" class="tab-item" :class="{ active: activeTab === tab.key }"
      ...
      <div class="row g-0">
        ...
        <div class="col-lg-6 ps-lg-5">
          ...
          <div class="info-field">
            ...
            <a v-if="profile.collaboration?.company_link" :href="profile.collaboration.company_link" target="_blank"
              class="field-link">
    ...
    <div v-if="activeTab === 'education'" class="info-panel tab-fade">
      ...
      <div v-if="profile.educations?.length">
        <div class="timeline-item" v-for="(edu, i) in profile.educations" :key="edu.id" :style="`--delay:${i * 60}ms`">
    ...
    <div v-if="activeTab === 'project'" class="info-panel tab-fade">
      ...
      <div class="proj-grid" v-if="profile.projects?.length">
        <a v-for="(proj, i) in profile.projects" :key="proj.id" :href="proj.link" target="_blank" class="proj-card"
          :style="`--delay:${i * 60}ms`">
    ...
    <div v-if="activeTab === 'skills'" class="info-panel tab-fade">
      ...
      <div class="skills-wrap" v-if="profile.skills?.length">
        <span class="skill-tag" v-for="(skill, i) in profile.skills" :key="skill.id" :style="`--delay:${i * 30}ms`">{{
          skill.name }}</span>
      </div>
...
.tab-item.active {
  color: var(--v-mid);
  border-bottom-color: var(--v-mid);
  font-weight: 700;
}

/* ── Tab animation ── */
.tab-fade {
  animation: tabIn .3s cubic-bezier(.22, 1, .36, 1) both;
}
