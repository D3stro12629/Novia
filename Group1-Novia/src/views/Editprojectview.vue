          ...
          <div class="form-body">
            ...
            <div class="field-group">
              ...
              <div class="input-wrap">
                ...
                <input v-model="form.title" type="text" class="f-input" placeholder="e.g. DCC Government Portal"
                  maxlength="120" />
              </div>
            ...
            <div class="field-group">
              ...
              <div class="input-wrap">
                ...
                <input v-model="form.link" type="url" class="f-input" placeholder="https://dcc.gov.kh"
                  @blur="validateUrl" />
              </div>
              <p class="field-error" v-if="urlError">{{ urlError }}</p>
              <a class="url-preview" v-if="validUrl && !urlError" :href="form.link" target="_blank">
                <Globe :size="11" />
                {{ shortLink(form.link) }}
            ...
            <div class="form-footer">
              ...
              <button class="btn-save text-black" :disabled="saving || !form.title.trim() || !validUrl" @click="save">
      ...
      <div class="col-lg-7">
        <div class="form-card">
          ...
          <div class="proj-list" v-else>
            <div class="proj-row" v-for="(proj, i) in projects" :key="proj.id" :style="`--d:${i * 50}ms`"
