<template>
  ...
  <div class="row g-4">
        ...
        <div class="form-body">
          ...
          <div class="field-group">
            ...
            <div class="input-wrap">
              ...
              <input v-model="schoolSearch" type="text" class="f-input" placeholder="Search or enter school name…"
                @input="filterSchools" @focus="showSchoolDrop = true" @blur="delayHide('school')" />
            </div>
            <!-- Dropdown -->
            <Transition name="drop">
              <div class="auto-drop" v-if="showSchoolDrop && filteredSchools.length">
                <button class="drop-item" v-for="s in filteredSchools" :key="s.id" @mousedown.prevent="selectSchool(s)">
            ...
            <div class="selected-pill" v-if="form.school_id && form.school_name">
              ...
              <button class="pill-remove" @click="clearSchool">
                <X :size="10" />
              </button>
            </div>
          </div>
          ...
          <div class="field-group">
            ...
            <div class="input-wrap">
              ...
              <input v-model="subjectSearch" type="text" class="f-input" placeholder="Search or enter subject…"
                @input="filterSubjects" @focus="showSubjectDrop = true" @blur="delayHide('subject')" />
            </div>
            <Transition name="drop">
              <div class="auto-drop" v-if="showSubjectDrop && filteredSubjects.length">
                <button class="drop-item" v-for="s in filteredSubjects" :key="s.id"
            ...
            <div class="selected-pill" v-if="form.subject_id && form.subject_name">
              ...
              <button class="pill-remove" @click="clearSubject">
                <X :size="10" />
              </button>
            </div>
          </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-6">
              <div class="field-group mb-0">
                ...
                <div class="input-wrap">
                  <CalendarDays :size="15" class="input-icon" />
                  <input v-model="form.end_date" type="month" class="f-input" :disabled="form.is_current" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="field-group">
            ...
            <textarea v-model="form.description" class="f-textarea" rows="3"
              placeholder="Activities, achievements, GPA…" maxlength="500" />
          ...
          <div class="form-footer">
            ...
            <button class="btn-save" :disabled="saving || !canSubmit" @click="save">
    ...
    <div class="col-lg-7">
      <div class="form-card">
        <div class="form-card-header">
          <div class="header-icon-wrap" style="background:#f0fdf4;color:#166534;">
            <ListChecks :size="16" />
          </div>
          <div>
        ...
        <div class="edu-list" v-else>
          <div class="edu-row" v-for="(edu, i) in educations" :key="edu.id" :style="`--d:${i * 50}ms`"
...
.btn-danger-v:hover:not(:disabled) {
  background: #b91c1c;
}

.btn-danger-v:disabled {
  opacity: .5;
  cursor: not-allowed;
}
