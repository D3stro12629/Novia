  ...
  <div class="container">
    ...
    <div class="row g-4">
          ...
          <div class="form-body">
            ...
            <div class="field-group">
              ...
              <div class="input-wrap">
                ...
                <input v-model="personal.portfolio_link" type="url" class="f-input"
      ...
      <div class="col-lg-6">
        <div class="form-card">
          <div class="form-card-header">
            <div class="header-icon-wrap" style="background:#fef3c7;color:#92400e;">
              <Briefcase :size="16" />
            </div>
            <div>
          ...
          <div class="form-body">
            ...
            <div class="field-group">
              ...
              <div class="input-wrap">
                ...
                <input v-model="professional.job_title" type="text" class="f-input"
            ...
            <div class="field-group">
              ...
              <textarea v-model="professional.responsibility" class="f-textarea" rows="4"
            ...
            <div class="field-group">
              ...
              <div class="input-wrap">
                ...
                <input v-model="passwords.current" :type="showPwd[0] ? 'text' : 'password'" class="f-input pe-10"
            ...
            <div class="row g-3">
              <div class="col-6">
                <div class="field-group mb-0">
                  ...
                  <div class="input-wrap">
                    <KeyRound :size="15" class="input-icon" />
                    <input v-model="passwords.password" :type="showPwd[1] ? 'text' : 'password'" class="f-input pe-10"
              ...
              <div class="col-6">
                <div class="field-group mb-0">
                  ...
                  <div class="input-wrap">
                    <KeyRound :size="15" class="input-icon" />
                    <input v-model="passwords.password_confirmation" :type="showPwd[2] ? 'text' : 'password'"
                      class="f-input pe-10" placeholder="Confirm" />
            ...
            <!-- Save professional -->
            <div class="form-footer">
              <button class="btn-ghost-v" :disabled="!passwords.current" @click="savePassword">
...
.btn-ghost-v:hover:not(:disabled) {
  background: #ddd6fe;
}

.btn-ghost-v:disabled {
  opacity: .45;
  cursor: not-allowed;
}
